...
import { Compass, Mail, Lock, User, Eye, EyeOff, ArrowLeft, CheckCircle2 } from 'lucide-react';
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: '#64748b' }}>
            Start your personalised career discovery journey, free
          </p>
        </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 mt-1.5">
                <CheckCircle2
                  ...
                  style={{ color: password.length >= 8 ? '#4CAF82' : '#cbd5e1' }}
                />
        ...
        <p className="text-center text-sm mt-6" style={{ color: '#64748b' }}>
          ...
          <Link href="/signin" className="font-semibold text-[#4F8CFF] hover:underline">
            Sign in
          </Link>
        </p>
      </motion.div>
